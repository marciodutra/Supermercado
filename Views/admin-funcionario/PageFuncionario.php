...
$pedidos = PedidoController::getPedidos()["active"];

if ($_POST) {
  $acao = $_POST["acao"];

  if ($acao == "Comprar"){
    PedidoController::changeStatus($_POST["idPedido"], "Realizado");
    //var_dump($_POST['idPedido']);
    header('Location: ../endereco.php');
  }else if ($acao == "Preparar") {
    PedidoController::changeStatus($_POST["idPedido"], "Preparado");
  } else if ($acao == "Conferir") {
    PedidoController::changeStatus($_POST["idPedido"], "Conferido e embalado");
  } else if ($acao == "Voltar") {
    PedidoController::changeStatus($_POST["idPedido"], "Repreparar");
  } else if ($acao == "Entregar") {
    PedidoController::changeStatus($_POST["idPedido"], "Entregue");
  }
    ...
    <nav class="navbar navbar-expand-md fixed-top navbar-black">
      <div class="container">
        <a style="color: #fff;
            ...
            font-weight: 700;
            letter-spacing: 2px;" href="PageFuncionario.php" class="navbar-brand"><i style="margin-right: 2px;" class="fab fa-opencart"></i>
                  CompraCerta
                </a>
          ...
          <body id="page-gerente">
            ...
            <section class="h-100">
              <div class="container h-100" style="margin-block: 1%;">
                <div class="row">
                  <div class="col mb-5">
                    <h2 style="padding-top: -15px; margin-bottom: -30px; margin-top: 30px;">Pedidos Ativos:</h2>
                  </div>
                </div>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><a href="setorPreparacao.php?idPedido=<?= $pedido->getId() ?>" class="btn btn-primary">Preparar</td>
        </a>
        <td><a href="SetorConferencia-Embalagem.php?idPedido=<?= $pedido->getId() ?>" class="btn btn-warning">Conferir e Embalar</td></a>
        <td><a href="SetorEntrega.php?idPedido=<?= $pedido->getId() ?>" class="btn btn-success">Entregar</td></a>
        </tr>
