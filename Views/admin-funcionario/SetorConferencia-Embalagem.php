  ...
  <nav class="navbar navbar-expand-md navbar-light fixed-top navbar-black">
    <div class="container">
      <a style="color: #fff;
        ...
        font-weight: 700;
        letter-spacing: 2px;" href="SetorConferencia-Embalagem.php" class="navbar-brand"><i style="margin-right: 2px;" class="fab fa-opencart"></i>
        CompraCerta
      </a>
  ...
  <main class="page">
    ...
    <section class="shopping-cart dark">
      ...
      <div class="container">
        <div class="row">
          <div class="col mb-5">
            <h2 style="padding-top: -15px; margin-bottom: -30px; margin-top: 30px;">Coferir | Embalar Pedido N° #00001:</h2>
          </div>
        </div>
        <div class="content">
          <div class="row">
            ...
            <div class="col-lg-4">
              ...
              <div class="">
                <div style="margin-top: 13.3%; margin-left: 13%;" class="col-md-12 quantity">
                  <label style="font-size: 25px;" for="quantity">Conferirido | Embalado:</label>
                </div>
            ...
            <div style="margin-left: 30px; margin-bottom: -170px;" class="col-md-4">
              <a style="text-decoration: none;" href="PageFuncionario.php"><button style="font-size: 25px;" type="button" class="btn btn-danger btn-lg btn-block">Voltar para preparação</button></a>
            </div>
            </form>
            ...
            <form action="PageFuncionario.php" method="post">
              ...
              <div style="margin-left: 730px; margin-top: 2px; margin-bottom: 40px;" class="col-md-4">
...
-->
  <footer>
    ...
    <div class="footer">
      <p style="text-align: center; margin-top: 20px;">Copyright &copy; 2021 CompraCerta | Todos os direitos reservados.</p>
    </div>
  </footer>
  <!--/Fim rodape-->
</body>
