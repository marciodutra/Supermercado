...
.dropdown:hover .dropbtn {
  ...
  <body id="page-gerente">
    ...
    <ul style="padding-left: 115px; margin-bottom: 10px; margin-top: -30px;" class="nav nav-tabs">
      <li class="nav-item">
        <a class="nav-link active" href="PaginaGerente.php">Funcionários</a>
      </li>
      <li class="nav-item">
    ...
    <div class="container">
      ...
      <div class="row mb-4">
        <div class="col-md-4">
            <input type="text" class="form-control" placeholder="Nome" id="nome-funcionario" />
        </div>
      ...
      <div class="row">
        <div class="col-md-8">
            <select class="form-control" id="setor-funcionario">
              <option value="">Setor de Atuação</option>
              <option value="1">Preparação</option>
              <option value="2">Conferência</option>
          ...
          <table class="table" >
            ...
            <tbody id="listaDespesas">
              ...
              foreach ($funcionarios as $funcionario) {
                ...
                $setor = $funcionario->getSetorFuncionario();
    ...
    <footer><!--Incio rodape-->
      ...
      <div class="" style="text-align: center; margin-top: 20px; color: rgb(213, 221, 212);">
