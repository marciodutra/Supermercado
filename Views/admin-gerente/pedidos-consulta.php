...
$pedidos = PedidoController::getPedidos()["all"];
...
<body id="page-gerente">
  <section id="cadastro" style=" height: 110px;">
  ...
  <ul style="padding-left: 115px; margin-bottom: 10px; margin-top: -30px;" class="nav nav-tabs">
    ...
    <li class="nav-item">
      <a class="nav-link active" href="pedidos-consulta.php">Pedidos</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="cliente-consulta.php">Clientes</a>
    </li>
  </ul>
  ...
  <div class="container">
    ...
    <div class="row mb-4">
      <div class="col-md-4">
        <input type="text" class="form-control" placeholder="N° do pedido" id="numero-pedido" />
      </div>

      <div class="col-md-2">
        <input type="date" class="form-control" id="data-pedido" />
      </div>

      <div class="col-md-4">
        <select class="form-control" id="detalhe-pedido">
          <option value="">Detalhe do pedido</option>
          <option value="1">Pagamento Aprovado</option>
          <option value="2">Produto em Transporte</option>
